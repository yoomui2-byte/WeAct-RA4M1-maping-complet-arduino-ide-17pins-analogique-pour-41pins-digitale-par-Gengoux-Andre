...
const uint16_t P400_b[] = {
    PIN_SERIAL_RX      | CHANNEL_0,
    PIN_SERIAL_TX      | CHANNEL_0,
    PIN_SCK            | CHANNEL_0,   // SCK0  ← correct pour SPI hardware
    PIN_SCK            | CHANNEL_1,   // SCK1  ← aussi possible
    PIN_SCL            | CHANNEL_0,
    PIN_SDA            | CHANNEL_0,
    PIN_INTERRUPT      | CHANNEL_0,
    PIN_PWM            | CHANNEL_6 | PWM_CHANNEL_A | GPT_ODD_CFG,
    PIN_GTIOC          | CHANNEL_6 | GTIOC_PIN_B,
    PIN_AGT            | CHANNEL_0 | AGT_PIN_INPUT,
    PIN_AGT            | CHANNEL_0 | AGT_PIN_OUTPUT,
    LAST_ITEM_GUARD                                   // ← bien en dernier
};
#define P400 P400_b
...
extern "C" const PinMuxCfg_t g_pin_cfg[] = {
    ...
    { BSP_IO_PORT_04_PIN_00,    P400   }  /* (27) ← NOUVELLE BROCHE : D14 = P400 */
};
const size_t g_pin_cfg_size = sizeof(g_pin_cfg) / sizeof(PinMuxCfg_t);

// Initialisation des ports analogiques etendus
void initVariant() {
  // ... (code Minima existant)
  // Ajoutez pour ADC/DAC supplementaires
  R_IOPORT_PinCfg(&g_ioport_pin_cfg[ANEXT0], IOPORT_CFG_PERIPHERAL_PIN);  // Ex. pour A8
}
};
